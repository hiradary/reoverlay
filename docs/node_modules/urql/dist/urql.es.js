...
function _ref2(ref) {
  var stale = ref.stale, data = ref.data, error = ref.error, extensions = ref.extensions;
  return {
    fetching: !1,
    stale: !!stale,
    data: data,
...
var defaultClient, Context, Provider, Consumer, hasWarnedAboutDefault, useClient, initialState, useMutation, currentInit, useSource, useBehaviourSubject, useRequest, useQuery, useSubscription;
...
useSource = function(source, init) {
  function _ref() {
    isMounted.current = !1;
  }
...
useBehaviourSubject = function(value) {
...
useRequest = function(query, variables) {
...
useSubscription = function(args, handler) {
  function _ref(result, partial) {
