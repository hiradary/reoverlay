...
export declare const useSubscription: <T = any, R = T, V = object>(args: UseSubscriptionArgs<V>, handler?: SubscriptionHandler<T, R> | undefined) => UseSubscriptionResponse<R>;
