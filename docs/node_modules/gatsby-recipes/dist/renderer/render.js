...
const Wrapper = ({
  ...
  fallback: /*#__PURE__*/React.createElement("p", null, "Loading recipe...")
}, children));
...
const ResourceComponent = ({
  ...
  return (/*#__PURE__*/React.createElement(Suspense, {
      fallback: /*#__PURE__*/React.createElement("p", null, "Reading resource...")
    }, /*#__PURE__*/React.createElement(Resource, null, JSON.stringify({ ...readResource(Resource, {
        root: process.cwd()
      }, props),
      _props: userProps
    })))
...
const readResource = (resourceName, context, props) => {
  ...
  try {
    promise = resources[resourceName].plan(context, props).then(result => cache.set(key, result)).catch(e => console.log(e));
  } catch (e) {
    throw e;
  }
...
const render = async recipe => {
  const plan = {};
  const recipeWithWrapper = /*#__PURE__*/React.createElement(Wrapper, null, recipe);
  ...
  try {
    ...
    await Promise.all(promises); // Rerender with the resources and resolve the data
