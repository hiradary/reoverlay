...
const staticallyAnalyzeExports = (modulePath, resolver = require.resolve) => {
  ...
  (0, _traverse.default)(ast, {
    ...
    ExportSpecifier: function ExportSpecifier(astPath) {
      const exportName = (0, _get.default)(astPath, `node.exported.name`);
      isES6 = true;
    ...
    ExportDefaultDeclaration: function ExportDefaultDeclaration(astPath) {
      const name = (0, _get.default)(astPath, `node.declaration.name`);
    ...
    AssignmentExpression: function AssignmentExpression(astPath) {
      ...
      if ((0, _get.default)(nodeLeft, `property.name`) === `__esModule`) return; // get foo from `exports.foo = bar`

      if ((0, _get.default)(nodeLeft, `object.name`) === `exports`) {
        isCommonJS = true;
        exportNames.push(nodeLeft.property.name);
      } // get foo from `module.exports.foo = bar`


      if ((0, _get.default)(nodeLeft, `object.object.name`) === `module` && (0, _get.default)(nodeLeft, `object.property.name`) === `exports`) {
        isCommonJS = true;
        exportNames.push(nodeLeft.property.name);
      }
    }
